...
COPY . .
# cargo chef cook resolves workspace crates to recipe versions, which can
# diverge from the committed lock; --locked would then fail. Build without it
# so the lock is refreshed to the chef resolution.
